 ...
 */
package org.foi.nwtis.ljakopov.filteri;
 ...
 * @author Lovro
 */
@WebFilter(filterName = "KontrolaPristupa", urlPatterns = {"*.xhtml"}, dispatcherTypes = {DispatcherType.REQUEST})
public class KontrolaPristupa implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        if (reqURI.contains("/registracijaIPrijava.xhtml")
            ...
            System.out.println("NIJE HUKA");
            System.out.println("sveee");
            resp.sendRedirect(reqt.getContextPath() + "/faces/registracijaIPrijava.xhtml");
        }
